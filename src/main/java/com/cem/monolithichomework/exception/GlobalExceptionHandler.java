...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MonolithicHomeworkManagerException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleCommentAppManagerException(MonolithicHomeworkManagerException ex){
